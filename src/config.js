...
const EVIDENCE_LOG_FILE = path.join(EVIDENCE_DIR, "evidence.log");
const EVIDENCE_STATE_FILE = path.join(EVIDENCE_DIR, "state.json");
const EVIDENCE_HASH_ALGORITHM = process.env.EVIDENCE_HASH_ALGORITHM || "sha256";
const EVIDENCE_MAX_TIME_SKEW_MS = parseEnvNumber("EVIDENCE_MAX_TIME_SKEW_MS", 60000);
const EVIDENCE_ENABLED = parseEnvBoolean("EVIDENCE_ENABLED", true);
